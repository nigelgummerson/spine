...
const EXTRA_ALLOWED_VALUES = new Set<string>([
  ...
  'Schematic documentation only — verify all placements against patient anatomy',
  ...
  '1 per screw',
  // Screw defaults disclaimer — Hindi retains English per ASSI convention
  'Default starting values — adjust to fit patient anatomy',
  ...
  // Rod modal — English placeholders pending native-speaker translation
  'Apply to both sides',
  'Copy to other side',
  'Left rod length',
  'Right rod length',
