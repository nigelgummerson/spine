    ...
    if (isPortrait) {
        return (
            <div className="h-full flex flex-col overflow-hidden">
                {modals}
                <RodModal isOpen={rodModalOpen} onClose={() => setRodModalOpen(false)} onConfirm={handleRodConfirm} onDelete={handleRodDelete} initialSide={rodModalSide} leftRod={rodModalChart === 'plan' ? patientData.planLeftRod : patientData.leftRod} rightRod={rodModalChart === 'plan' ? patientData.planRightRod : patientData.rightRod} isEditing={true} screwSystem={patientData.screwSystem} />
