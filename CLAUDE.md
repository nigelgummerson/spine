...
- **v0.9.5-alpha** (2026-03-03): Fixed duplicate ID generation (Date.now() replaced with incrementing counter). Code formatting cleanup — compressed single-line logic expanded for readability.
